...
func registerMetadataRoutes(api *gin.RouterGroup) {
	...
	opdsGroup.Use(suppressOPDSHeadResponseBody(), middleware.OPDSAuthRequired())
	{
		...
		opdsGroup.HEAD("", opds.Root)
		opdsGroup.GET("/all", opds.All)
		opdsGroup.HEAD("/all", opds.All)
		opdsGroup.GET("/recent", opds.Recent)
		opdsGroup.HEAD("/recent", opds.Recent)
		...
		opdsGroup.GET("/works/:id/continuous/download", opds.WorkContinuousDownload)
		opdsGroup.HEAD("/works/:id/continuous/download", opds.WorkContinuousDownload)
		opdsGroup.GET("/works/:id/continuous/stream", opds.WorkContinuousStream)
		opdsGroup.HEAD("/works/:id/continuous/stream", opds.WorkContinuousStream)
		...
		opdsGroup.HEAD("/series", opds.Series)
		opdsGroup.GET("/series/:id", opds.SeriesDetail)
		opdsGroup.HEAD("/series/:id", opds.SeriesDetail)
		opdsGroup.GET("/series/:id/cover", opds.SeriesCover)
		opdsGroup.HEAD("/series/:id/cover", opds.SeriesCover)
		opdsGroup.GET("/search.xml", opds.SearchDescription)
		opdsGroup.HEAD("/search.xml", opds.SearchDescription)
		opdsGroup.GET("/search", opds.Search)
		opdsGroup.HEAD("/search", opds.Search)
		opdsGroup.GET("/cover/:id", opds.Cover)
		opdsGroup.HEAD("/cover/:id", opds.Cover)
		opdsGroup.GET("/work-cover/:id", opds.WorkCover)
		opdsGroup.HEAD("/work-cover/:id", opds.WorkCover)
		opdsGroup.GET("/unit-cover/:id", opds.UnitCover)
		opdsGroup.HEAD("/unit-cover/:id", opds.UnitCover)
		opdsGroup.GET("/stream/:id", opds.StreamPage)
		opdsGroup.HEAD("/stream/:id", opds.StreamPage)
