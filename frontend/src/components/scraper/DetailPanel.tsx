          ...
          <div className="rounded-xl border border-purple-500/20 bg-purple-500/5 p-3">
            <div className="mb-2 flex items-center justify-between">
              ...
              <div className="flex gap-1.5">
                <button onClick={handleAiInferApply} className="rounded-md bg-purple-500/20 px-2 py-0.5 text-[10px] font-medium text-purple-300 hover:bg-purple-500/30" title="仅应用到本卷">
                  应用本卷
                </button>
